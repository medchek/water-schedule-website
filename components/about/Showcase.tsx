  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center lg:w-1/2 space-y-3 text-center lg:text-left">
        <h2 className="text-xl md:text-2xl 2xl:text-3xl font-medium text-appDarkPurple/80 dark:text-appPurpleGrey/90">
          {number} • {title}
        </h2>
        <p className="text-base md:text-lg 2xl:text-xl text-[#4859a7] dark:text-[#b7bedc] 2xl:font-thin md:px-10 lg:px-0">
          {text}
        </p>
      </div>
      {/* IMAGE */}
